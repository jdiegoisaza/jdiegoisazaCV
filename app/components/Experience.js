    ...
    <section id="experiencia" className="bg-neutral-50 dark:bg-neutral-900/40 transition-colors">
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="relative">
          <div
            className="absolute left-[7px] top-2 bottom-2 w-px bg-neutral-200 dark:bg-neutral-700"
            aria-hidden="true"
          />
            ...
            {experiencia.map((job, idx) => (
              <Reveal key={`${job.empresa}-${job.periodo}`} delay={idx * 60}>
                <article className="relative pl-8">
                  <span
                    className="absolute left-0 top-1.5 w-[15px] h-[15px] rounded-full border-[3px] border-blue-600 dark:border-blue-400 bg-white dark:bg-neutral-950"
                    aria-hidden="true"
                  />
                  ...
                  <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-3">{job.ubicacion}</p>
                  <ul className="list-disc list-outside pl-5 space-y-1.5 text-neutral-700 dark:text-neutral-300 text-sm leading-relaxed">
